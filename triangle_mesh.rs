...
impl<Mon:Monomial> TriMesh<Mon> {
  ...
  pub fn new(fes: ~[ElTri],
             ...
             integration_abs_err: R,
             phys_reg_tags_by_fenum: Option<~[Tag]>,
             geom_ent_tags_by_fenum: Option<~[Tag]>) -> TriMesh<Mon> {
  ...
  */
  ...
  fn intg_facerel_poly_fn_on_oshape_int(& self, p: |& [R]| -> R, ub_max_var_deg_in_p: Deg, os: OShape) -> R {
  ...
  */
  fn intg_poly_fn_btw_pt_and_vert_seg(& self, 
                                      p: |& [R]| -> R, ub_max_var_deg_in_p: Deg,
                                      q: Point,
                                      slope_1: R, slope_2: R,
                                      vert_line_x: R) -> R {
  ...
  fn intg_facerel_poly_fn_on_oshape_side(& self, p: |& [R]| -> R, ub_p_deg: Deg, os: OShape, sf: SideFace) -> R {
  ...
  #[inline]
  fn sorted_vertexes(& self, ref_tri: & RefTri, v0: Point) -> (Point,Point,Point) {
    let sorted_pts = {
...
#[inline]
pub fn mk_endpoint_pair(pt1: Point, pt2: Point, endpoints_ordering: SideEndpointsOrdering) -> (Point, Point) {
