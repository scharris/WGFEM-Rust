...
\begin{frame}
  ...
  \begin{columns}
    \column{.5\textwidth}
      \uncover<3->{
        \frame{\includegraphics[width=6cm, height=5.1cm]{img/gmsh_tri_mesh.png}}
      }
    \column{.5\textwidth}
      \uncover<4->{
        \frame{\includegraphics[width=6cm, height=5.1cm]{img/rect_meshes_234.jpg}}
      }
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.50\textwidth}
      \alt<-1> {\frame{\includegraphics[width=6cm, height=4cm]{img/two_fes.pdf}}}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.50\textwidth}
      \uncover<2->{\frame{\includegraphics[width=6cm, height=4cm]{img/two_fes_bad_side_origin_2.pdf}}}
  \end{columns}
  \begin{itemize}[<+->]
...
\begin{frame}
  ...
  \pause
  \begin{itemize}[<+->]
    \item From the above it's clear that we only need to implement \spot<2->{$\phi$}, and only for basis shape function inputs,
