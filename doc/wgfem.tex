...
% TODO: Highlight calls to mesh and basis.  Emphasise that this module does not know the geometry at all, just defers to others,
% even for side iterations (use example which sums over sides instead of side-vs-side).
\begin{frame}
