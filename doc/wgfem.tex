...
\begin{frame}
  ...
  \vspace{.1cm}
  \uncover<+-> {
  So the method for computing the vbf value will be to sum $\mathfrak{a}(p_j, e_i)$ for all boundary side projections
  $p_j$ on the boundary sides of the supporting finite element of $e_i$.
  }}}
\end{frame}
